import "../_runtime.mjs";
import { E as invariant, S as isResolvedRedirect, T as isNotFound, _ as getStylesheetHref, a as attachRouterServerSsrUtils, b as executeRewriteInput, c as mergeHeaders, d as createSerializationAdapter, f as makeSerovalPlugin, g as getScriptPreloadAttrs, h as lu, i as stripSsrResponseBody, l as defaultSerovalPlugins, m as cu, n as normalizeSsrResponse, o as getNormalizedURL, p as Ou, r as replaceSsrResponse, s as getOrigin, t as isSsrResponse, u as createRawStreamRPCPlugin, v as resolveManifestAssetLink, w as rootRouteId, x as isRedirect, y as resolveManifestCssLink } from "../_libs/@tanstack/router-core+[...].mjs";
import { r as createMemoryHistory } from "../_libs/tanstack__history.mjs";
import { a as X_TSS_RAW_RESPONSE, d as getStartOptions, f as runWithStartContext, i as TSS_SERVER_FUNCTION, l as flattenMiddlewares, n as TSS_CONTENT_TYPE_FRAMED_VERSIONED, o as X_TSS_SERIALIZED, p as safeObjectMerge, r as TSS_FORMDATA_CONTEXT, s as createNullProtoObject, t as FrameType, u as getStartContext } from "./createServerFn-aZmUlApV.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CnfJS-7Z.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-C18VpA4t.mjs"),
		import("./start-CtfB454b.mjs"),

...
function createMemoryHistory(opts = { initialEntries: ["/"] }) {
	...
	const states = entries.map((_entry, index) => assignKeyAndIndex$1(index, void 0));
	const getLocation = () => parseHref$1(entries[index], states[index]);
	let blockers = [];
	const _getBlockers = () => blockers;
	const _setBlockers = (newBlockers) => blockers = newBlockers;
	return createHistory$1({
		getLocation,
...
//#endregion
export { parseHref as n, createMemoryHistory as r, createBrowserHistory as t };
